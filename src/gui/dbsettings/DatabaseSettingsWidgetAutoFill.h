...
#ifndef KEEPASSXC_DatabaseSettingsWidgetAutoFill_H
#define KEEPASSXC_DatabaseSettingsWidgetAutoFill_H
...
class DatabaseSettingsWidgetAutoFill : public DatabaseSettingsWidget
{
    Q_OBJECT

public:
    explicit DatabaseSettingsWidgetAutoFill(QWidget* parent = nullptr);
    Q_DISABLE_COPY(DatabaseSettingsWidgetAutoFill);
    ~DatabaseSettingsWidgetAutoFill() override;
...
protected:
    ...
    const QScopedPointer<Ui::DatabaseSettingsWidgetAutoFill> m_ui;
...
#endif // KEEPASSXC_DatabaseSettingsWidgetAutoFill_H
